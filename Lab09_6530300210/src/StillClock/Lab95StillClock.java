...
public class Lab95StillClock extends JPanel {
    ...
    protected void paintComponent(Graphics g) {
        ...
        System.out.println(
                (xCenter - clockRadius) + " " + (yCenter - clockRadius) + " " + (2 * clockRadius));
        // Draw circle
        ...
        //
        // for (int i = 0; i < 12; i++) {
        // int angle1 = (int) Math.toRadians(i * 30);
        // int x1 = (int) (xCenter + (clockRadius - 30) * Math.sin(angle1));
        // int y1 = (int) ((yCenter - 10) - (clockRadius - 30) * Math.cos(angle1));
        // int x2 = (int) (xCenter + (clockRadius - 10) * Math.sin(angle1));
        // int y2 = (int) ((yCenter - 10) - (clockRadius - 10) * Math.cos(angle1));
        // g.drawLine(x1, y1, x2, y2);
        // }

        // for (int i = 0; i < 12; i += 3) {
        // double angle = Math.toRadians(i * 30);
        // int x1 = (int) (xCenter + (clockRadius - 30) * Math.sin(angle));
        // int y1 = (int) ((yCenter) - (clockRadius - 30) * Math.cos(angle));
        // int x2 = (int) (xCenter + (clockRadius) * Math.sin(angle));
        // int y2 = (int) ((yCenter) - (clockRadius) * Math.cos(angle));
        // g.drawLine(x1, y1, x2, y2);
        // }
        int angle = 0;
        int count = 2;
        for (int i = 0; i < 60; i++) {
            ...
            if (angle % 30 == 0) {
                ...
                int yNumber = (int) (xCenter + ((clockRadius - 25) * (Math.sin(Math.toRadians(angle)))));
